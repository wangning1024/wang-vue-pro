...
import cn.zs.wang.framework.datapermission.core.util.DataPermissionUtils;
...
import cn.zs.wang.module.system.convert.user.UserConvert;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:wangyuanma}")
