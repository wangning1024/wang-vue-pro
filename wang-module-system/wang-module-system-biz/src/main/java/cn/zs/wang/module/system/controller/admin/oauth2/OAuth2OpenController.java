package cn.zs.wang.module.system.controller.admin.oauth2;
...
import cn.zs.wang.framework.common.util.http.HttpUtils;
import cn.zs.wang.framework.common.util.json.JsonUtils;
import cn.zs.wang.framework.operatelog.core.annotations.OperateLog;
import cn.zs.wang.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import cn.zs.wang.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import cn.zs.wang.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import cn.zs.wang.module.system.convert.oauth2.OAuth2OpenConvert;
import cn.zs.wang.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import cn.zs.wang.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import cn.zs.wang.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import cn.zs.wang.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import cn.zs.wang.module.system.service.oauth2.OAuth2ApproveService;
import cn.zs.wang.module.system.service.oauth2.OAuth2ClientService;
import cn.zs.wang.module.system.service.oauth2.OAuth2GrantService;
import cn.zs.wang.module.system.service.oauth2.OAuth2TokenService;
import cn.zs.wang.module.system.util.oauth2.OAuth2Utils;
...
import static cn.zs.wang.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.zs.wang.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static cn.zs.wang.framework.common.pojo.CommonResult.success;
import static cn.zs.wang.framework.common.util.collection.CollectionUtils.convertList;
import static cn.zs.wang.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
