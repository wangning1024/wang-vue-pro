package cn.zs.wang.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.zs.wang.framework.common.enums.CommonStatusEnum;
import cn.zs.wang.framework.common.exception.ServiceException;
import cn.zs.wang.framework.common.pojo.PageResult;
import cn.zs.wang.framework.common.util.collection.ArrayUtils;
import cn.zs.wang.framework.common.util.collection.CollectionUtils;
import cn.zs.wang.framework.test.core.ut.BaseDbUnitTest;
import cn.zs.wang.module.infra.api.file.FileApi;
import cn.zs.wang.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.zs.wang.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.zs.wang.module.system.controller.admin.user.vo.user.*;
import cn.zs.wang.module.system.dal.dataobject.dept.DeptDO;
import cn.zs.wang.module.system.dal.dataobject.dept.PostDO;
import cn.zs.wang.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.zs.wang.module.system.dal.mysql.dept.UserPostMapper;
import cn.zs.wang.module.system.dal.mysql.user.AdminUserMapper;
import cn.zs.wang.module.system.enums.common.SexEnum;
import cn.zs.wang.module.system.service.dept.DeptService;
import cn.zs.wang.module.system.service.dept.PostService;
import cn.zs.wang.module.system.service.permission.PermissionService;
import cn.zs.wang.module.system.service.tenant.TenantService;
...
import static cn.zs.wang.framework.common.util.collection.SetUtils.asSet;
import static cn.zs.wang.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.zs.wang.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.zs.wang.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.zs.wang.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.zs.wang.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.zs.wang.framework.test.core.util.RandomUtils.*;
import static cn.zs.wang.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("wangyuanma");
        ...
        assertEquals("wangyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("wangyuanma"))).thenReturn("java");
