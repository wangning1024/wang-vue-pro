...
* 演示地址【Vue3 + element-plus】：<http://dashboard-vue3.wang.iocoder.cn>
* 演示地址【Vue3 + vben(ant-design-vue)】：<http://dashboard-vben.wang.iocoder.cn>
* 演示地址【Vue2 + element-ui】：<http://dashboard.wang.iocoder.cn>
...
* 管理后台的电脑端：Vue3 提供 [element-plus](https://gitee.com/wangcode/wang-ui-admin-vue3)、[vben(ant-design-vue)](https://gitee.com/wangcode/wang-ui-admin-vben) 两个版本，Vue2 提供 [element-ui](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/wang-ui-admin) 版本
...
![架构演进](https://static.iocoder.cn/wang-roadmap.png?imageView2/2/format/webp)
...
| [wang-cloud](https://gitee.com/zhijiantianya/wang-cloud)      | [![Gitee star](https://gitee.com/zhijiantianya/wang-cloud/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/wang-cloud) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/wang-cloud.svg?style=social&label=Stars)](https://github.com/YunaiV/wang-cloud)               | 基于 Spring Cloud 微服务架构       |
| [Spring-Boot-Labs](https://gitee.com/wangcode/SpringBoot-Labs) | [![Gitee star](https://gitee.com/wangcode/SpringBoot-Labs/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/wang-cloud) [![GitHub stars](https://img.shields.io/github/stars/wangcode/SpringBoot-Labs.svg?style=social&label=Stars)](https://github.com/wangcode/SpringBoot-Labs) | 系统学习 Spring Boot & Cloud 专栏 |

### 前端项目

| 项目                                                                                                       | Star                                                                                                                                                                                                                                                                                                                                                           | 简介                                     |
|----------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| [wang-ui-admin-vue3](https://gitee.com/wangcode/wang-ui-admin-vue3)                                   | [![Gitee star](https://gitee.com/wangcode/wang-ui-admin-vue3/badge/star.svg?theme=white)](https://gitee.com/wangcode/wang-ui-admin-vue3) [![GitHub stars](https://img.shields.io/github/stars/wangcode/wang-ui-admin-vue3.svg?style=social&label=Stars)](https://github.com/wangcode/wang-ui-admin-vue3)                                               | 基于 Vue3 + element-plus 实现的管理后台         |
| [wang-ui-admin-vben](https://gitee.com/wangcode/wang-ui-admin-vben)                                   | [![Gitee star](https://gitee.com/wangcode/wang-ui-admin-vben/badge/star.svg?theme=white)](https://gitee.com/wangcode/wang-ui-admin-vben) [![GitHub stars](https://img.shields.io/github/stars/wangcode/wang-ui-admin-vben.svg?style=social&label=Stars)](https://github.com/wangcode/wang-ui-admin-vben)                                               | 基于 Vue3 + vben(ant-design-vue) 实现的管理后台 |
| [wang-ui-admin](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/wang-ui-admin)               | [![Gitee star](https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/wang-ui-admin) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ruoyi-vue-pro.svg?style=social&label=Stars)](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/wang-ui-admin)               | 基于 Vue2 + element-ui 实现的管理后台           |
| [wang-ui-admin-uniapp](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/wang-ui-admin-uniapp) | [![Gitee star](https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/wang-ui-admin-uniapp) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ruoyi-vue-pro.svg?style=social&label=Stars)](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/wang-ui-admin-uniapp) | 基于 uni-app + uni-ui 实现的管理后台的小程序        |
| [wang-ui-go-view](https://gitee.com/wangcode/wang-ui-go-view)                                         | [![Gitee star](https://gitee.com/wangcode/wang-ui-go-view/badge/star.svg?theme=white)](https://gitee.com/wangcode/wang-ui-go-view) [![GitHub stars](https://img.shields.io/github/stars/wangcode/wang-ui-go-view.svg?style=social&label=Stars)](https://github.com/wangcode/wang-ui-go-view)                                                           | 基于 Vue3 + naive-ui 实现的大屏报表             |
| [wang-ui-app](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/wang-ui-app)                   | [![Gitee star](https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/wang-ui-app) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ruoyi-vue-pro.svg?style=social&label=Stars)](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/wang-ui-app)                   | 基于 uni-app + uview 实现的用户 App           |
...
| 项目                                                                       | 说明                 |
|--------------------------------------------------------------------------|--------------------|
| `wang-dependencies`                                                     | Maven 依赖版本管理       |
| `wang-framework`                                                        | Java 框架拓展          |
| `wang-server`                                                           | 管理后台 + 用户 APP 的服务端 |
| `wang-module-system`                                                    | 系统功能的 Module 模块    |
| `wang-module-member`                                                    | 会员中心的 Module 模块    |
| `wang-module-infra`                                                     | 基础设施的 Module 模块    |
| `wang-module-bpm`                                                       | 工作流程的 Module 模块    |
| `wang-module-pay`                                                       | 支付系统的 Module 模块    |
| `wang-module-mall`                                                      | 商城系统的 Module 模块    |
| `wang-module-mp`                                                        | 微信公众号的 Module 模块   |
| `wang-module-report`                                                    | 大屏报表 Module 模块     |
...
| [Druid](https://github.com/alibaba/druid)                                                   | JDBC 连接池、监控组件    | 1.2.16      | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?wang) |
| [MyBatis Plus](https://mp.baomidou.com/)                                                    | MyBatis 增强工具包    | 3.5.3.1     | [文档](http://www.iocoder.cn/Spring-Boot/MyBatis/?wang)         |
| [Dynamic Datasource](https://dynamic-datasource.com/)                                       | 动态数据源            | 3.6.1       | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?wang) |
| [Redis](https://redis.io/)                                                                  | key-value 数据库    | 5.0 / 6.0   |                                                                |
| [Redisson](https://github.com/redisson/redisson)                                            | Redis 客户端        | 3.18.0      | [文档](http://www.iocoder.cn/Spring-Boot/Redis/?wang)           |
| [Spring MVC](https://github.com/spring-projects/spring-framework/tree/master/spring-webmvc) | MVC 框架           | 5.3.24      | [文档](http://www.iocoder.cn/SpringMVC/MVC/?wang)               |
| [Spring Security](https://github.com/spring-projects/spring-security)                       | Spring 安全框架      | 5.7.6       | [文档](http://www.iocoder.cn/Spring-Boot/Spring-Security/?wang) |
| [Hibernate Validator](https://github.com/hibernate/hibernate-validator)                     | 参数校验组件           | 6.2.5       | [文档](http://www.iocoder.cn/Spring-Boot/Validation/?wang)      |
| [Flowable](https://github.com/flowable/flowable-engine)                                     | 工作流引擎            | 6.8.0       | [文档](https://doc.iocoder.cn/bpm/)                              |
| [Quartz](https://github.com/quartz-scheduler)                                               | 任务调度组件           | 2.3.2       | [文档](http://www.iocoder.cn/Spring-Boot/Job/?wang)             |
| [Springdoc](https://springdoc.org/)                                                         | Swagger 文档       | 1.6.15      | [文档](http://www.iocoder.cn/Spring-Boot/Swagger/?wang)         |
| [Resilience4j](https://github.com/resilience4j/resilience4j)                                | 服务保障组件           | 1.7.1       | [文档](http://www.iocoder.cn/Spring-Boot/Resilience4j/?wang)    |
| [SkyWalking](https://skywalking.apache.org/)                                                | 分布式应用追踪系统        | 8.12.0      | [文档](http://www.iocoder.cn/Spring-Boot/SkyWalking/?wang)      |
| [Spring Boot Admin](https://github.com/codecentric/spring-boot-admin)                       | Spring Boot 监控平台 | 2.7.10      | [文档](http://www.iocoder.cn/Spring-Boot/Admin/?wang)           |
| [Jackson](https://github.com/FasterXML/jackson)                                             | JSON 工具库         | 2.13.3      |                                                                |
| [MapStruct](https://mapstruct.org/)                                                         | Java Bean 转换     | 1.5.3.Final | [文档](http://www.iocoder.cn/Spring-Boot/MapStruct/?wang)       |
| [Lombok](https://projectlombok.org/)                                                        | 消除冗长的 Java 代码    | 1.18.26     | [文档](http://www.iocoder.cn/Spring-Boot/Lombok/?wang)          |
