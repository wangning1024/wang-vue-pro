package cn.zs.wang.framework.tracer.config;

import cn.zs.wang.framework.common.enums.WebFilterOrderEnum;
import cn.zs.wang.framework.tracer.core.aop.BizTraceAspect;
import cn.zs.wang.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "wang.tracer", value = "enable", matchIfMissing = true)
public class WangTracerAutoConfiguration {
