package cn.zs.wang.framework.operatelog.core.aop;
...
import cn.zs.wang.framework.operatelog.core.service.OperateLog;
import cn.zs.wang.framework.operatelog.core.service.OperateLogFrameworkService;
import cn.zs.wang.framework.web.core.util.WebFrameworkUtils;
...
import static cn.zs.wang.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.zs.wang.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        cn.zs.wang.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                cn.zs.wang.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         cn.zs.wang.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           cn.zs.wang.framework.operatelog.core.annotations.OperateLog operateLog,
