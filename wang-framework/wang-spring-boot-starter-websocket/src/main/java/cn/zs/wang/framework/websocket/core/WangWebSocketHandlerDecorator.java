package cn.zs.wang.framework.websocket.core;
...
public class WangWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public WangWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
