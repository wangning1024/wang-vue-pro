 ...
 */
@AutoConfiguration
// 允许使用 wang.websocket.enable=false 禁用websocket
@ConditionalOnProperty(prefix = "wang.websocket", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(WebSocketProperties.class)
public class WangWebSocketAutoConfiguration {
    @Bean
