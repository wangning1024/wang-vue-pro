package cn.zs.wang.module.infra.service.codegen.inner;
...
import cn.zs.wang.framework.common.util.date.LocalDateTimeUtils;
...
import cn.zs.wang.framework.excel.core.util.ExcelUtils;
import cn.zs.wang.framework.mybatis.core.dataobject.BaseDO;
...
import cn.zs.wang.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import cn.zs.wang.module.infra.dal.dataobject.codegen.CodegenTableDO;
import cn.zs.wang.module.infra.enums.codegen.CodegenFrontTypeEnum;
import cn.zs.wang.module.infra.enums.codegen.CodegenSceneEnum;
import cn.zs.wang.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "wang-module-${table.moduleName}/" + // 顶级模块
                "wang-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "wang-module-${table.moduleName}/" + // 顶级模块
                "wang-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "wang-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "wang-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
