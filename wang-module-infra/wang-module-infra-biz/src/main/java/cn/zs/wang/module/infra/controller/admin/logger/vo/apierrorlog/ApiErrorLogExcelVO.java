package cn.zs.wang.module.infra.controller.admin.logger.vo.apierrorlog;

import cn.zs.wang.framework.excel.core.annotations.DictFormat;
import cn.zs.wang.framework.excel.core.convert.DictConvert;
import cn.zs.wang.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(cn.zs.wang.module.system.enums.DictTypeConstants.USER_TYPE)
