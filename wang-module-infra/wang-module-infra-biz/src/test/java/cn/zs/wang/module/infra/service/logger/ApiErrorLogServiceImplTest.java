package cn.zs.wang.module.infra.service.logger;
...
import cn.zs.wang.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import cn.zs.wang.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.zs.wang.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.zs.wang.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.zs.wang.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.zs.wang.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.zs.wang.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("wang-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("wang-test");
