package cn.zs.wang.module.infra.service.job;

import cn.zs.wang.framework.common.pojo.PageResult;
import cn.zs.wang.framework.quartz.core.scheduler.SchedulerManager;
import cn.zs.wang.framework.test.core.ut.BaseDbUnitTest;
import cn.zs.wang.module.infra.controller.admin.job.vo.job.JobCreateReqVO;
import cn.zs.wang.module.infra.controller.admin.job.vo.job.JobExportReqVO;
import cn.zs.wang.module.infra.controller.admin.job.vo.job.JobPageReqVO;
import cn.zs.wang.module.infra.controller.admin.job.vo.job.JobUpdateReqVO;
import cn.zs.wang.module.infra.dal.dataobject.job.JobDO;
import cn.zs.wang.module.infra.dal.mysql.job.JobMapper;
import cn.zs.wang.module.infra.enums.job.JobStatusEnum;
