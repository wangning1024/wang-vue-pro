package cn.zs.wang.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.StrUtil;
import cn.zs.wang.framework.common.pojo.PageResult;
import cn.zs.wang.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import cn.zs.wang.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import cn.zs.wang.module.mp.convert.message.MpMessageConvert;
import cn.zs.wang.module.mp.dal.dataobject.account.MpAccountDO;
import cn.zs.wang.module.mp.dal.dataobject.message.MpMessageDO;
import cn.zs.wang.module.mp.dal.dataobject.user.MpUserDO;
import cn.zs.wang.module.mp.dal.mysql.message.MpMessageMapper;
import cn.zs.wang.module.mp.enums.message.MpMessageSendFromEnum;
import cn.zs.wang.module.mp.framework.mp.core.MpServiceFactory;
import cn.zs.wang.module.mp.framework.mp.core.util.MpUtils;
import cn.zs.wang.module.mp.service.account.MpAccountService;
import cn.zs.wang.module.mp.service.material.MpMaterialService;
import cn.zs.wang.module.mp.service.message.bo.MpMessageSendOutReqBO;
import cn.zs.wang.module.mp.service.user.MpUserService;
...
import static cn.zs.wang.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
