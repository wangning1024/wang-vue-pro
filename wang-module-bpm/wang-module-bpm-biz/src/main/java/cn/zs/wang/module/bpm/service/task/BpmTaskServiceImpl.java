package cn.zs.wang.module.bpm.service.task;
...
import cn.zs.wang.framework.common.util.number.NumberUtils;
import cn.zs.wang.framework.common.util.object.PageUtils;
import cn.zs.wang.module.bpm.controller.admin.task.vo.task.*;
import cn.zs.wang.module.bpm.convert.task.BpmTaskConvert;
import cn.zs.wang.module.bpm.dal.dataobject.task.BpmTaskExtDO;
import cn.zs.wang.module.bpm.dal.mysql.task.BpmTaskExtMapper;
import cn.zs.wang.module.bpm.enums.task.BpmProcessInstanceDeleteReasonEnum;
import cn.zs.wang.module.bpm.enums.task.BpmProcessInstanceResultEnum;
import cn.zs.wang.module.bpm.service.message.BpmMessageService;
