package cn.zs.wang.module.member.service.user;
...
import cn.zs.wang.module.member.controller.app.user.vo.AppUserUpdateMobileReqVO;
...
import cn.zs.wang.module.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, WangRedisAutoConfiguration.class})
