...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.zs.wang";
    private static final String ARTIFACT_ID = "wang";
    private static final String PACKAGE_NAME = "cn.zs.wang";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.zs.wang";
        String artifactIdNew = "wang";
        String packageNameNew = "cn.zs.wang";
